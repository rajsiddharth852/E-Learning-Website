...
?>  
    ...
    <div class="container-fluid remove-vid-marg">
      ...
      <div class="vid-content" >
        <h1 class="my-content">Welcome to College M-Point</h1>
        <small class="my-content">Come and Learn ❤</small><br />
        <?php    
    ...
    <div class="container-fluid bg-danger"> <!-- Start Social Follow -->
        <div class="row text-white text-center p-1">
          <div class="col-sm">
          <a class="text-white social-hover" href="http://youtube.com/@apkasiddharth"><i class="fab fa-whatsapp"></i> Youtube</a>
          </div>
          <div class="col-sm">
            <a class="text-white social-hover" href="https://www.linkedin.com/in/siddharth..."><i class="fa fa-linkedin fa-fw"></i> Linkedin</a>
          </div>
          <div class="col-sm">
            <a class="text-white social-hover" href="https://www.facebook.com/rajsiddharth852"><i class="fab fa-facebook-f"></i> Facebook</a>
          </div>
          <div class="col-sm">
            <a class="text-white social-hover" href="https://instagram.com/rajsiddharth852?igshid=MTIzZWQxMDU="><i class="fab fa-instagram"></i> Instagram</a>
          </div>
        </div>
    ...
    <div class="container-fluid p-4" style="background-color:#E9ECEF">
      <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
          <div class="col-sm">
            <h5>About Us</h5>
              <p>Our team will guide you till your Admission confirmation. 1 to 1 discussion with student about
              ■Their field of interest
              ■On that basis ,branch selection
              ■Choice filling
              ■Seat Freezing 
              ■ Scholarship
              ■ Best strategy and important chapter( Study Matterial ) </p>
          </div>
          <div class="col-sm">
            <h5>Category</h5>
            <a class="text-dark" href="#">College Counselling</a><br />
            <a class="text-dark" href="#">BITSAT Crash course</a><br />
            <a class="text-dark" href="#">Manipal Crash Course</a><br />
            <a class="text-dark" href="#">Reasoning & Aptitude</a><br />
            <a class="text-dark" href="#">English</a><br />
          </div>
          <div class="col-sm">
            <h5>Contact Us</h5>
            <p>College M-point <br> Near Manipal university Jaipur<br> Jaipur , Rajasthan <br> Ph. 000000000 </p>
          </div>
        </div>
      </div>
